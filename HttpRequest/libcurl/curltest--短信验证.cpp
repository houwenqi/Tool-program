...
#define POSTURL "http://116.204.97.227:8099/?apply;111;123456;123456;CN" 
...
int main(int argc,char *argv[])  
{
    ...
    sprintf(POSTFIELDS,"appid=%d&pass=%s&mobile=%ld&text=【蜂巢互联】您的验证码是：%s，验证码将于60秒后失效，请尽快使用。&extCode=%d",appid,pass,mobile,num,1);
    printf("data is %s\n",POSTFIELDS );
